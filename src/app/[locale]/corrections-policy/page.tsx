...
export default function CorrectionsPolicy() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-12 bg-white mt-10 shadow-sm rounded-lg">
      <h1 className="text-4xl font-bold mb-6 text-gray-900 border-b pb-4">Corrections Policy</h1>
      ...
      <div className="prose prose-lg max-w-none text-gray-700">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900">How We Handle Corrections</h2>
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900">Retractions</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900">Updating Stories</h2>
        <p className="mb-6">
        ...
        <div className="bg-gray-50 p-6 rounded-lg mt-10 border border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Request a Correction</h3>
