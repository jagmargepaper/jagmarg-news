...
export default function EthicsPolicy() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-12 bg-white mt-10 shadow-sm rounded-lg">
      <h1 className="text-4xl font-bold mb-6 text-gray-900 dark:text-gray-100 border-b pb-4">Editorial & Ethics Policy</h1>
      ...
      <div className="prose prose-lg max-w-none text-gray-700 dark:text-gray-300">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-gray-100">1. Independence and Impartiality</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-gray-100">2. Conflicts of Interest</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-gray-100">3. Anonymous Sourcing</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-gray-100">4. Bribes, Gifts, and Freebies</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900 dark:text-gray-100">5. Privacy and Sensitivity</h2>
        <p className="mb-6">
