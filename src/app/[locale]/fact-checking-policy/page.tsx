...
export default function FactCheckingPolicy() {
  return (
    <main className="max-w-4xl mx-auto px-4 py-12 bg-white mt-10 shadow-sm rounded-lg">
      <h1 className="text-4xl font-bold mb-6 text-gray-900 border-b pb-4">Fact-Checking Policy</h1>
      ...
      <div className="prose prose-lg max-w-none text-gray-700">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900">1. Verification Process</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900">2. Dealing with Rumors and Misinformation</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900">3. Sourcing and Attribution</h2>
        <p className="mb-6">
        ...
        <h2 className="text-2xl font-semibold mt-8 mb-4 text-gray-900">4. Continuous Training</h2>
        <p className="mb-6">
        ...
        <div className="bg-gray-50 p-6 rounded-lg mt-10 border border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Notice an error?</h3>
